...
describe('DomainModel', () => {
  describe('constructor', () => {
    it('should throw an error if value is null', () => {
      expect(() => new TestDomainModel(null as any)).toThrowError('DomainModel value cannot be null or undefined.');
    });

    it('should throw an error if value is undefined', () => {
      expect(() => new TestDomainModel(undefined as any)).toThrowError('DomainModel value cannot be null or undefined.');
    });
    ...
    it('should call the validate method', () => {
      const validateSpy = vi.spyOn(TestDomainModel.prototype, 'validate' as keyof TestDomainModel);
